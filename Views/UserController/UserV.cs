...
namespace SmartHome
{
    public partial class UserV : UserControl
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    User us = new User(comboBox1.Text, textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text);

                    UserControlle.AjouterUser(us);
                    con.Close();
                    ChampsVide();
                    GetList();
        ...
        private void UserV_Load(object sender, EventArgs e)
        {
